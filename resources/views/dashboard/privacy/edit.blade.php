                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{trans('admin.edit.privacy')}}
                                </li>
                            </ol>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{trans('admin.edit.privacy')}}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.privacy.update',$Privacy->id)}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
 <h4 class="form-section"><i class="ft-home"></i> {{trans('admin.edit.privacy')}} </h4>
                                              <div class="row">
<div class="col-md-6">
    <div class="form-group">
       <label>{{trans('admin.name_ar')}}</label>
        <input type="text"
        value="{{$Privacy->name_ar}}"
        class="form-control
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                       ...
                                                       <label>{{trans('admin.desc_en')}}</label>
                                                            <textarea
                                                            value="{{$Privacy->body_en}}"
                                                              name="body_en" id="description_en"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                            >{{$Privacy->body_en}}</textarea>
