                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="">{{trans('admin.termss')}}</a>
                                </li>
                                <li class="breadcrumb-item active"> {{trans('admin.add.term')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                          ...
                                          <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> {{trans('admin.add.term')}} </h4>
