        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{trans('admin.insurance')}} </h3>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{trans('admin.insurance')}}</h4>
...
<label>{{trans('admin.clinic')}}</label>
<label>{{trans('admin.name_ar')}}</label>