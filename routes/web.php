...
use App\Http\Controllers\Dashboard\ReceptionController;
...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath']], function () {
    ...
    Route::group(['namespace' => 'Dashboard', 'middleware' => 'auth:web', 'prefix' => 'dashboard'], function () {
        ...
        Route::group(['prefix' => 'reception'], function () {
            ...
            Route::post('store', [ReceptionController::class, 'store'])->name('reception.store');
            Route::get('edit/{id}', [ReceptionController::class, 'edit'])->name('reception.edit');
            Route::post('update/{id}', [ReceptionController::class, 'update'])->name('reception.update');
            Route::get('delete/{id}', [ReceptionController::class, 'destroy'])->name('reception.destroy');
        });
    });
